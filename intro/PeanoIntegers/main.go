//Peao Integers are represented by a linked
//list whose nodes contain no datea
...
//the arithmetic value of a Number is the count of the nodes comprisng hte list
